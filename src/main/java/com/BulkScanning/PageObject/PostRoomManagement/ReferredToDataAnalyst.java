...
public class ReferredToDataAnalyst {
    ...
    /**
     * Used to select Referred to Data Analyst Tab under Postroom Management.
     */
    ...
    /**
     * This method verifies the column header for the table present on the referred to data analyst page in a sequential order and matches the
     column names with the data array {@link ReferredToDataAnalyst#tblReferredToDataAnalyst}.
     */
