...
//		/Thread.sleep(1000);
	//	webDriverHandler.byXpath("//div[starts-with(@class,'xdsoft_datetimepicker')][starts-with(@style,'display: block')]//div[@data-hour='18']").waitClickable(15,100).click();
		//Thread.sleep(1000);		
		/*
		 * webDriverHandler.byXpath("//*[@id='EventToDate']").waitClickable(15,100).
		 * click(); Thread.sleep(1000); webDriverHandler.
		 * byXpath("//div[starts-with(@class,'xdsoft_datetimepicker')][starts-with(@style,'display: block')]//div[@data-hour='21']"
		 * ).waitClickable().click();
		 * 
		 * // webDriverHandler.
		 * byXpath("//div[starts-with(@class,'xdsoft_datetimepicker')][starts-with(@style,'display: block')]//div[@data-hour='18']"
		 * ).waitClickable().click(); //Thread.sleep(1000);
		 * driver.findElement(By.xpath("//*[@id='EventToDate']")).click();
		 * Thread.sleep(1500); WebElement w5 = driver.findElement(By.
		 * xpath("//div[starts-with(@class,'xdsoft_datetimepicker')][starts-with(@style,'display: block')]//div[@data-hour='21']"
		 * )); w5.click(); Thread.sleep(1000); WebElement w6 =
		 * driver.findElement(By.xpath("//*[@id='Url']"));
		 * w6.sendKeys("https://stestcumulus.inspiredenergy.co.uk/Core/Home/Loginsso");
		 * Thread.sleep(1000); // need to add category
		 * 
		 * 
		 * 
		 * 
		 * driver.findElement(By.
		 * xpath("//label[@class='switch']//span[@class='slider round']")).click();
		 * driver.findElement(By.
		 * xpath("//form[@id='newEventForm']//div[@class='modal-footer']//button[@class='btn btn-sm btn-primary']"
		 * )).click(); Thread.sleep(1000);
		 * driver.findElement(By.xpath("//*[@id='btnDelete']")).click();
		 * driver.findElement(By.
		 * xpath("//div[@class='swal2-actions']//button[@class='swal2-confirm swal2-styled']"
		 * )).click();
		 */
    }
}
