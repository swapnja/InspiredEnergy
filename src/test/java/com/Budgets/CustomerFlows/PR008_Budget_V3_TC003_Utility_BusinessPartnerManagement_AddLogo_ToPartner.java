...
public class PR008_Budget_V3_TC003_Utility_BusinessPartnerManagement_AddLogo_ToPartner extends AbstractCustomer {

    public PR008_Budget_V3_TC003_Utility_BusinessPartnerManagement_AddLogo_ToPartner() throws IOException {
    }
    @Test
	...
	partnersPageHandler.selectFirstPartner();
	partnersPageHandler.replaceLogo("png");
