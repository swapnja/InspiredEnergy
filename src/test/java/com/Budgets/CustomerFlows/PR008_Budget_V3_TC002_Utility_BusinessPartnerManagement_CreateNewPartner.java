...
public class PR008_Budget_V3_TC002_Utility_BusinessPartnerManagement_CreateNewPartner extends AbstractCustomer {

    public PR008_Budget_V3_TC002_Utility_BusinessPartnerManagement_CreateNewPartner() throws IOException {
    }
    @Test
