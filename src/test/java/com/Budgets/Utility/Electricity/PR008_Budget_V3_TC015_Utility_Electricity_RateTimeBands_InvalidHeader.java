...
public class PR008_Budget_V3_TC015_Utility_Electricity_RateTimeBands_InvalidHeader extends AbstractTestNg {

	public PR008_Budget_V3_TC015_Utility_Electricity_RateTimeBands_InvalidHeader() throws IOException {
	}
	...
	public void BudgetConsoleVerifyTest() throws InterruptedException, IOException {
		...
		webDriverHandler.byXpath(prop.getProperty("ElectricityRateTimeBands")).leftPanelclick();
		ImportPageHandlerElectricity importPageHandler = new ImportPageHandlerElectricity(webDriverHandler, prop);
		String path = Paths.get("BudgetTestData/Electricity/RateTimeBands/PR008_Budget_V3_TC015_Utility_Electricity_RateTimeBands_InvalidHeader.xlsx").toAbsolutePath().toString();
